export function GitHubIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="#0A0A0A" aria-hidden="true" focusable="false">
...
export function EyeOffIcon() {
  return (
    ...
    >
      <path d="M3 3l18 18" />
      <path d="M10.6 5.1A10.5 10.5 0 0 1 12 5c6.5 0 10 7 10 7a17.8 17.8 0 0 1-3.05 3.86M6.45 6.6C3.55 8.2 2 12 2 12s3.5 7 10 7a10.3 10.3 0 0 0 4-.82" />
...
export function ErrorIcon() {
  return (
    ...
    >
      ...
      <path d="M8 4.8v3.6M8 11.2h.01" strokeLinecap="round" />
    </svg>
  );
}
